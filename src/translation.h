...
MAKE_WORD_TRANSLATION(NXT_MODE_PUMP_TITLE, "Modes", "Modes", "", "")
...
MAKE_WORD_TRANSLATION(NXT_SUBMENU1,  "Filtering", "Filtration", "", "")
...
MAKE_WORD_TRANSLATION(NXT_SUBMENU4,  "Winter Mode", "Mode Hivernage", "", "")
