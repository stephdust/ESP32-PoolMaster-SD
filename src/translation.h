...
MAKE_WORD_TRANSLATION(NXT_SUBMENU8,  "Calibrate pH Probe", "Calibration Sonde pH", "", "")
MAKE_WORD_TRANSLATION(NXT_SUBMENU9,  "Calibrate Orp Probe", "Calibration Sonde Orp", "", "")
MAKE_WORD_TRANSLATION(NXT_SUBMENU10, "Tank Status", "Etat des Bidons", "", "")
